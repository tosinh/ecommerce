        ...
        <div className='min-w-screen min-h-screen bg-[#161d31] flex justify-center items-center'>
            <div className='w-[350px] text-[#d0d2d6] p-2'>
                <div className='bg-[#283046] p-4 rounded-md'>
                    <h2 className='text-xl mb-3'>Chào mừng mới website Hải tốt</h2>
                    <p className='text-sm mb-3'>Hãy đăng ký tài khoản của bạn và bắt đầu kinh doanh</p>
                    <form onSubmit={submit}>
                        ...
                        <div className='flex items-center w-full gap-3 mb-3'>
                            ...
                            <label htmlFor="checkbox">Tôi đồng ý với điều khoản & dịch vụ</label>
                        </div>
                        ...
                        <div className='flex items-center mb-3 gap-3 justify-center'>
                            <p><Link to='/login'>Đăng nhập tại đây</Link></p>
                        </div>
