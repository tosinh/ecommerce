                        ...
                        <div className='px-8 py-8'>
                            ...
                            <div>
                                <form onSubmit={login} className='text-slate-600'>
                                    ...
                                    <button className='px-8 w-full py-2 bg-purple-500 shadow-lg hover:shadow-indigo-500/30 text-white rounded-md'>Đăng nhập</button>
                                </form>
                            ...
                            <div className='text-center text-slate-600 pt-1'>
                                <p>Bạn không có tài khoản ? <Link className='text-blue-500' to='/register'>Đăng ký</Link></p>
                            </div>
                            <div className='text-center text-slate-600 pt-1'>
                                <p> <a target='_black' className='text-blue-500' href='http://localhost:3001/register'>Đăng ký</a> tài khoản người bán</p>
                            </div>
                        </div>
